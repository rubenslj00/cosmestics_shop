!(function(t, e) {
  ...
  var ct,
    ...
    lt = function(t, e) {
      for (var n = 0; n < t.childNodes.length; n++)
        if (I(t.childNodes[n], e)) return t.childNodes[n];
    },
    dt = function(t) {
      return !(
    ...
    ft = function(t) {
      ...
      if (ot()) v("SweetAlert2 requires document to initialize");
        ...
        var i,
          ...
          m,
          g,
          h = "string" == typeof (i = t.target) ? document.querySelector(i) : i;
        h.appendChild(o),
          (r = t),
    ...
    mt = function(t, e) {
      t.jquery ? gt(e, t) : (e.innerHTML = t.toString());
    },
    gt = function(t, e) {
  ...
  function Et(t, s) {
    ...
    X(u), (u.innerHTML = "");
    var l = parseInt(
      void 0 === s.currentProgressStep ? Tt() : s.currentProgressStep
    );
      ...
      (function(t, e) {
        ...
        if (n && e.icon === n.icon && w()) q(w(), e, "icon");
          ...
          if (-1 !== Object.keys(F).indexOf(e.icon)) {
            ...
            X(o), It(o, e), jt(), q(o, e, "icon"), st(o, e.showClass.icon);
          } else
            v(
